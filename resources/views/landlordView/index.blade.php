        ...
        <div class="grid grid-cols-1 lg:grid-cols-[250px,1fr]">
            ...
            <div class="bg-slate-50 p-4 text-blue-950 font-nun">
                <nav class="flex flex-col items-center">
                    ...
                    <a class="mb-6 text-center border border-grey-200 rounded-full py-2 w-48 text-blue-950 font-bold shadow-lg">Property</a>
                    <a href="{{ route('landlordView.status') }}" class="mb-6 text-center text-blue-950 font-bold border border-transparent rounded-full py-2 w-48 hover:border-slate-200">Status</a>
            ...
            <div class="h-screen bg-white rounded-3xl p-4 grid lg:grid-rows-[92px,repeat(3,60px)]">
                ...
                <div class="grid grid-cols-1 gap-4">
                    ...
                    <div class="border border-gray-300 rounded-3xl grid grid-cols-7 gap-4 items-center py-2 px-6 shadow-transparent hover:shadow-lg">
                        ...
                        <div class="text-center font-bold"><span>$ </span>{{ $properties->price }}</div>
